...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/esast-util-builder
   cd esast-util-builder
   ```
...
```sh
https://github.com/flex-development/esast-util-builder/compare/main...$branch
```
...
[discussion-qa]: https://github.com/flex-development/esast-util-builder/discussions/new?category=q-a
